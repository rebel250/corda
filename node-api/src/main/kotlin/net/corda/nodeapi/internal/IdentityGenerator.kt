...
object IdentityGenerator {
    ...
    private fun generateToDisk(dirs: List<Path>,
        ...
        keyPairs.zip(dirs) { keyPair, dir ->
            val serviceKeyCert = X509Utilities.createCertificate(CertificateType.NODE_CA, issuer.certificate, issuer.keyPair, name, keyPair.public)
            val compositeKeyCert = X509Utilities.createCertificate(CertificateType.NODE_CA, issuer.certificate, issuer.keyPair, name, key)
